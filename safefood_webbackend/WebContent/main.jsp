...
<body>
		...
		<div class="container-fluid">
			...
			<c:if test="${islogin eq 'isLogin'}">
				<div id="navbar" class="navbar-collapse collapse">
					...
					<ul class="nav navbar-nav navbar-right">
						<li><a href="mypage.jsp"><img width="20px" src="./img/사람.png">회원정보수정</a></li>
						<li id=logout><a href="#"><img width="20px" src="./img/사람.png">Logout</a></li>
					</ul>
				</div>
			</c:if>
		</div>
	...
	<a href="./main.html"> <img src="./img/ssafy.png"></a>
	<ul class="nav navbar-nav navbar-right">
		<li class="active"><a href="#" style="margin-right: 30px">공지
				사항 </a></li>
		<li><a href="./productInfo.html" style="margin-right: 30px">상품
				정보</a></li>
	...
	<div class="main col-12" style="margin-left: 300px">
		...
		<div class="isotope-container row grid-space-10"
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="./pdetail.html"><img width="200" class="center" alt="아카페라아메리카노"
							src="img/아카페라아메리카노.jpg"></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="#"><img width="200" class="center" alt="누크바"
							src="img/N45누크바.jpg"></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="#"><img width="200" class="center" alt="비비빅"
							src="img/비비빅.jpg"></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="#"><img width="200" class="center" alt="서울우유바나나"
							src="img/서울우유바나나.jpg"></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="#"><img width="200" class="center" alt="메로나"
							src="img/메로나.jpg"></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 isotope-item app-development"
				...
				<div class="image-box hc-shadow-2 text-center mb-20">
					<div class="overlay-container">
						<a href="#"><img width="200" class="center" alt="진라면컵매운맛"
							src="img/진라면컵매운맛.jpg"></a>
					</div>
				</div>
			</div>
	...
	<div class="modal fade" id="myModal" role="dialog">
		<div class="modal-dialog">
			...
			<!-- 회원등록  form -->
				...
				<form action="main.do?action=SignUp"name="registerform" method="post" action="./register">
								...
								<div class="container">
									<div class="form-group">
										<label for="email">ID*:</label> <br /> <input type="text"
											class="form-control" id="email" name="pid">
									</div>
									<div class="form-group">
										<label for="pwd">Password*:</label><br /> <input
											type="password" class="form-control" id="pwd"
											placeholder="Enter password" name="ppw1">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="username">이름*</label><br /> <input type="text"
											id="userId" class="form-control" maxlength="20" value="" name="pname">
									</div>
									<div class="form-group">
										<label for="useradress">주소*</label><br /> <input type="text"
											id="userId" class="form-control" maxlength="20" value="" name="paddr">
									</div>
									<div class="form-group">
